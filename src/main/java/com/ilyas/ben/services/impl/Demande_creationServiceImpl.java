...
import com.ilyas.ben.dao.IDemande_creationDao;
import com.ilyas.ben.entities.Demande_creation;
import com.ilyas.ben.services.IDemande_creationService;

@Transactional
public class Demande_creationServiceImpl implements IDemande_creationService{
	
	private IDemande_creationDao dao;
	
	public void setDao(IDemande_creationDao dao) {
		this.dao = dao;
	}
