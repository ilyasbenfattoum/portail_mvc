...
<head>
 <meta charset="utf-8" />
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<%=request.getContextPath() %>/resources/clientresources/assets/img/apple-icon.png">
  <link rel="icon" type="image/png" href="<%=request.getContextPath() %>/resources/clientresources/assets/img/favicon.png">
...
<body id="page-top">
  ...
  <script href="<%=request.getContextPath() %>/resources/clientresources/vendor/jquery/jquery.min.js"></script>
  <script href="<%=request.getContextPath() %>/resources/clientresources/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

  <!-- Core plugin JavaScript-->
  <script href="<%=request.getContextPath() %>/resources/clientresources/vendor/jquery-easing/jquery.easing.min.js"></script>

  <!-- Custom scripts for all pages-->
  <script href="<%=request.getContextPath() %>/resources/clientresources/js/sb-admin-2.min.js"></script>
