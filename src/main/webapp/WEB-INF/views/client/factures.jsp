  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
		 ...
		 <!-- Content Row -->
		  ...
		  <div class="col-xl-8 col-lg-7"></center>
              ...
              <div class="card shadow mb-4">
				...
				<a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Upload document</a>
      ...
      <div id="project">
        ...
        <div><span>EMAIL</span> <a href="">john@example.com</a></div>
