        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
			  ...
			  <img src="<%=request.getContextPath() %>/resources/clientresources/img\micho.jpg" alt="Image" class="img-fluid">
			  </div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-2">Forgot Your Password?</h1>
                    <p class="mb-4">We get it, stuff happens. Just enter your email address below and we'll contact the administrator to reset your password!</p>
                  </div>
                  <form class="user">
