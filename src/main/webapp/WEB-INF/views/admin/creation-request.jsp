  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="active"><a href="<%=request.getContextPath() %>/creation-requestadmin/"><i class="icon-file"></i><span>Creation requests</span> </a></li>
          ...
          <div class="widget widget-table action-table">
            ...
            <div class="widget-content">
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  <c:forEach items="${demandescre}" var = "demandescre">
                  <tr>
                   <td> ${demandescre.getId_demandec() } </td>
                    <td> ${demandescre.getNom_prenom() } </td>
                    <td> ${demandescre.getPassword() } </td>
                    <td> ${demandescre.getEmail() } </td>
