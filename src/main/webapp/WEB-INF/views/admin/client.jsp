  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="active"><a href="<%=request.getContextPath() %>/clientadmin/"><i class="icon-list-alt"></i><span>Clients</span> </a> </li>
              ...
              <table class="table table-striped table-bordered">
                ...
                <c:forEach items="${clients}" var = "client">
                  ...
                  <tr>
                    ...
                    <td> ${client.getNom_prenom() } </td>
                    <td> ${client.getPassword() } </td>
                    <td> ${client.getEmail() } </td>
                    <td> ${client.getAdresse_client() } </td>
                    <td> ${client.getVille() } </td>
                    <td> ${client.getPays() } </td>
                    <td class="td-actions"><a href="<%=request.getContextPath() %>/client-editadmin/" class="btn btn-small btn-success"><i class="btn-icon-only  icon-edit"> </i></a></td>
                  </tr>
				  </c:forEach>             
